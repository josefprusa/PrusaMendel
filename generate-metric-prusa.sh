openscad -s metric-prusa/bar-clamps.stl source/bar-clamp.scad
openscad -s metric-prusa/bearing-guide.stl source/bearing-guide.scad
openscad -s metric-prusa/belt-clamp-bed-holder.stl source/belt-clamp-bed-holder.scad
...
openscad -s metric-prusa/wadebits.stl source/wadebits.scad
