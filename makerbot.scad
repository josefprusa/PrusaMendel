...
translate([58,19,15]) rotate([0,0,-90]) import_stl("frame-vertex-foot.stl");
translate([58,19,13]) rotate([0,0,-90]) interface();
translate([58,60,15]) rotate([0,0,90]) import_stl("frame-vertex-foot.stl");
translate([58,60,13]) rotate([0,0,90])  interface();
translate([58,60,45]) rotate([0,0,90]) import_stl("frame-vertex-foot.stl");
translate([58,60,43]) rotate([0,0,90])  interface();
translate([58,60,30]) rotate([0,0,90]) import_stl("frame-vertex-foot.stl");
translate([58,60,28]) rotate([0,0,90])  interface();
