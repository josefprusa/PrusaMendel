...
translate([33.5,-20.5,10])cylinder(h=30,r=m3_diameter/2, center=true);
translate([4.5,-10,10])cylinder(h=30,r=m3_diameter/2, center=true);
translate([15,19.2,10])cylinder(h=30,r=m3_diameter/2, center=true);
}
}
ybract();
